...
3. To collectively learn how to make best of use, and improve, interactive theorem provers, such as the Lean language. 
...
**Tau Ceti is focused on the last point: building an open library, at a quality level sufficient that others can reuse and build on top of it, and at a significant even scale that building on top of it allows downstream projects to reach the research frontier across many areas of mathematics.**
