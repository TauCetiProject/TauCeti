...
**Tau Ceti is focused on the last point: building an open library, at a quality level sufficient that others can reuse and build on top of it, and at a significant enough scale that building on top of it allows downstream projects to reach the research frontier across many areas of mathematics.**
