...
-- Non-public: these support the self-pairing computation.
...
* `TauCeti.characterPairing_GL2EllipticInduction_self`: its character has norm `q - 1` when
  `θ` is not fixed by the `q`-power map.
