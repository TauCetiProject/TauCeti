...
* `PointedCone.IsFaceOf.mapsTo_id`: the identity linear map sends a face into its
  ambient cone.
...
theorem _root_.PointedCone.IsFaceOf.mapsTo_id {τ σ : PointedCone ℝ V} (hτσ : τ.IsFaceOf σ) :
