...
theorem isMorseCriticalPoint_iff (I : ModelWithCorners ℝ E E) :
    IsMorseCriticalPoint I f x ↔
      IsNondegenerateCriticalPoint (f ∘ (extChartAt I x).symm) (extChartAt I x x) :=
  Iff.rfl

/-- Negating a function preserves its Morse critical points. -/
theorem IsMorseCriticalPoint.neg {I : ModelWithCorners ℝ E E}
...
@[simp]
theorem isMorseCriticalPoint_neg_iff {I : ModelWithCorners ℝ E E} :
...
def IsMorseOn (I : ModelWithCorners ℝ E E) (f : M → ℝ) (s : Set M) : Prop :=
...
theorem isMorseOn_iff {I : ModelWithCorners ℝ E E} :
    IsMorseOn I f s ↔
      ContMDiffOn I (modelWithCornersSelf ℝ ℝ) ∞ f s ∧
        ∀ x, x ∈ s →
          fderiv ℝ (f ∘ (extChartAt I x).symm) (extChartAt I x x) = 0 →
...
theorem IsMorseOn.contMDiffOn {I : ModelWithCorners ℝ E E}
...
theorem IsMorseOn.isMorseCriticalPoint {I : ModelWithCorners ℝ E E}
...
theorem IsMorseOn.mono {I : ModelWithCorners ℝ E E}
...
theorem IsMorseOn.neg {I : ModelWithCorners ℝ E E}
...
def IsMorse (I : ModelWithCorners ℝ E E) (f : M → ℝ) : Prop :=
  IsMorseOn I f univ

/-- A function is Morse exactly when it is smooth and all of its critical points are
nondegenerate. -/
theorem isMorse_iff {I : ModelWithCorners ℝ E E} :
    IsMorse I f ↔
...
theorem IsMorse.contMDiff {I : ModelWithCorners ℝ E E}
...
theorem IsMorse.isMorseCriticalPoint {I : ModelWithCorners ℝ E E}
    (h : IsMorse I f)
    (hcrit : fderiv ℝ (f ∘ (extChartAt I x).symm) (extChartAt I x x) = 0) :
    IsMorseCriticalPoint I f x :=
