...
intersection. The equation vanishes exactly when the unordered tuple contains the basepoint,
on a neighborhood of the given parameter. -/
...
local equation. If the order is finite, the curve avoids the divisor at all sufficiently close
other parameters; infinite order means that it lies in the divisor locally. -/
