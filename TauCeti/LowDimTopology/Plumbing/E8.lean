...
/-- The canonical characteristic covector of the `E₈` plumbing is zero. -/
@[simp]
theorem e8Plumbing_canonicalCharacteristic_eq_zero :
...
theorem e8Plumbing_characteristicWeight_canonical_nonneg (x : Fin 8 → ℤ) :
    0 ≤ e8Plumbing.characteristicWeight
      ⟨e8Plumbing.canonicalCharacteristic,
        e8Plumbing.isCharacteristicVector_canonicalCharacteristic⟩ x :=
  e8Plumbing.characteristicWeight_canonical_nonneg_of_weight_eq_neg_two
