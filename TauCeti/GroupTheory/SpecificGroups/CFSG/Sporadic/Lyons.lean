...
* `R_H1`, fifth relator: the right-hand side is `a⁻¹ b a⁻¹ b⁻¹ a⁻¹ b⁻² c a⁻¹ b⁻¹ c⁻¹ b a`, with
  inverses at the fifth and eleventh letters;
* `R_G`, third relator: the right-hand side is
  `c⁻¹ b c² a c⁻¹ b d⁻¹ c a c⁻¹ b c⁻¹ b⁻² c a⁻¹ c d⁻¹ c b² c d a d⁻¹ c⁻¹ d⁻¹ c b a⁻¹ b`, with
  `c⁻¹`, `a⁻¹`, and `b²` at the twelfth, sixteenth, and twentieth positions;
* `R_G`, fourth relator: the commutator's second entry ends `b a b⁻¹ c d⁻¹ c d`;
* `R_G`, fifth relator: the right-hand side is
  `a⁻¹ d⁻¹ c⁻¹ b c⁻² a b⁻¹ c a⁻¹ b² c b⁻¹ c a⁻¹ c⁻¹ d b⁻¹ a⁻¹`.
