...
cyclic (`TauCeti.UpperHalfPlane.isCyclic_stabilizer`). Hence the point stabilizers of a Fuchsian
...
(`TauCeti.UpperHalfPlane.exists_isPrimitiveRoot_stabilizerDeriv`).

## Main declarations

* `TauCeti.UpperHalfPlane.instIsCyclicStabilizer`: the point stabilizers of a discrete subgroup
