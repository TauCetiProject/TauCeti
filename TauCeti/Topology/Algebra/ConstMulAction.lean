...
/-- A monoid action remains properly discontinuous on every invariant subspace. -/
theorem properlyDiscontinuousSMul {G X : Type*} [Monoid G] [TopologicalSpace X] [MulAction G X]
