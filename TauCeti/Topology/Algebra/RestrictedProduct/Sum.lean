...
@[to_additive (attr := simp) addRestrictedProductSum_apply_inl]
...
@[to_additive (attr := simp) addRestrictedProductSum_apply_inr]
...
@[to_additive (attr := simp) addRestrictedProductSum_symm_apply_inl]
...
@[to_additive (attr := simp) addRestrictedProductSum_symm_apply_inr]
...
@[to_additive continuous_addRestrictedProductSum]
...
@[to_additive continuous_addRestrictedProductSum_symm_comp_prodMap_inclusion]
...
@[to_additive continuous_addRestrictedProductSum_symm]
...
@[to_additive continuous_addRestrictedProductSum_symm_of_finite_left]
