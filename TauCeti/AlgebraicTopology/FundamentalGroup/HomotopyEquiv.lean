...
* `ContinuousMap.HomotopyEquiv.bijective_fundamentalGroup_map`: the homomorphism
...
theorem _root_.ContinuousMap.HomotopyEquiv.bijective_fundamentalGroup_map (e : X ≃ₕ Y) (x : X) :
