...
* `Algebra.finiteDimensional_of_pow_eq` and `Algebra.isSeparable_of_pow_eq`: finiteness and
  separability of a radical extension generated by a root of `X ^ n - C a`.
...
theorem _root_.Algebra.finiteDimensional_of_pow_eq {y : E} {n : ℕ} {a : F}
  ...
  exact @LinearEquiv.finiteDimensional _ _ _ _ _ _ _ _
    ((IntermediateField.equivOfEq hgen).trans IntermediateField.topEquiv).toLinearEquiv hfin
...
theorem _root_.Algebra.isSeparable_of_pow_eq {y : E} {n : ℕ} {a : F}
  ...
  exact @AlgEquiv.Algebra.isSeparable _ _ _ _ _ _ _ _
    ((IntermediateField.equivOfEq hgen).trans IntermediateField.topEquiv) hsep'
