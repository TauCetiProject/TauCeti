...
* `TauCeti.card_zpowers_neg_one_zmod_five_units` — the subgroup generated by `-1` among the
  units modulo five has order two.
...
/-- The subgroup generated by `-1` in the units modulo five has order two. -/
theorem card_zpowers_neg_one_zmod_five_units :
