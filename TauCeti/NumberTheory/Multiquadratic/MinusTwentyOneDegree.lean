...
This file re-exports `TauCeti.NumberTheory.Multiquadratic.MinusTwentyOneExamples`, where the
degree and Galois-cardinality worked examples for `ℚ(√-1, √-3, √-7)` share the same private
prime-discriminant setup.
