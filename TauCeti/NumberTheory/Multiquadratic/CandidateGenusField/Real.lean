...
@[simp] theorem mem_candidateGenusFieldReal_iff (hd : Squarefree d)
  ...
  by
    ...
    change x ∈ ((maximalRealSubfield (candidateGenusField hd)).toIntermediateField _ :
      Set (candidateGenusField hd)) ↔ _
    rw [Subfield.coe_toIntermediateField]
    exact mem_maximalRealSubfield_iff x
