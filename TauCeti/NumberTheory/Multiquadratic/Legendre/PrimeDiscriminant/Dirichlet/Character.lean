...
private theorem DirichletCharacter.eq_apply_of_factorsThrough {N d : ℕ} [NeZero N]
...
private theorem DirichletCharacter.conductor_eq_four_of_apply_one_ne_apply_three
  ...
  · have hfac := DirichletCharacter.factorsThrough_conductor chi
    ...
    exact (hdist (DirichletCharacter.eq_apply_of_factorsThrough _ hfac
...
private theorem DirichletCharacter.conductor_eq_eight_of_apply_one_ne_apply_five
