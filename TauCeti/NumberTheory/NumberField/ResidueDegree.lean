...
* `IsDedekindDomain.HeightOneSpectrum.asIdeal_dvd_span_singleton_algebraMap_iff`: a height-one
  prime divides the ideal generated by an integer exactly when the rational prime below it does.
...
below it does. -/
@[simp]
theorem _root_.IsDedekindDomain.HeightOneSpectrum.asIdeal_dvd_span_singleton_algebraMap_iff
...
private theorem finite_primesDividing (K : Type*) [Field K] [NumberField K] {n : ℤ} (hn : n ≠ 0) :
  ...
  exact (𝔭.asIdeal_dvd_span_singleton_algebraMap_iff n).mpr h𝔭
