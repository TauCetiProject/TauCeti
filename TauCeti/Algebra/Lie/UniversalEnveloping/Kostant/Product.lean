...
theorem kostantForm_apply_mem_prod
...
theorem prodRight_baseChangeKostantExpHom
    ...
    E (baseChangeKostantExpHom e h
      ...
      (kostantForm_apply_mem_prod e h ρ σ M N hM hN) i (hρ.prodMap hσ) t z) =
  ...
  rw [coe_baseChangeKostantExpHom e h
    ((LinearMap.prodMapAlgHom ℚ V W).comp (ρ.prod σ)) (M.prod N)
    (kostantForm_apply_mem_prod e h ρ σ M N hM hN) i (hρ.prodMap hσ) t]
