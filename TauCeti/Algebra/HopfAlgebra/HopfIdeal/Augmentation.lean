...
theorem centralAugmentationIdeal_eq_span :
...
theorem centralAugmentationIdeal_le_iff {I : Ideal H} :
  ...
  rw [centralAugmentationIdeal_eq_span, Ideal.span_le]
...
theorem mem_centralAugmentationIdeal_of_mem {z : H} (hz : z ∈ centralAugmentation R H) :
  ...
  rw [centralAugmentationIdeal_eq_span]
...
theorem centralAugmentationIdeal_ne_top [Nontrivial R] :
    centralAugmentationIdeal R H ≠ ⊤ := by
  have hproper : (augmentation R H).toIdeal ≠ ⊤ := by
    rw [augmentation_toIdeal]
    exact RingHom.ker_ne_top _
  exact ne_top_of_le_ne_top hproper (centralAugmentationIdeal_le_augmentation R H)
