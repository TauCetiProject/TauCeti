...
theorem mem_centralAugmentationIdeal_of_mem_centralAugmentation {z : H}
    (hz : z ∈ centralAugmentation R H) :
...
theorem exists_finset_span_eq_centralAugmentationIdeal [IsNoetherianRing H] :
