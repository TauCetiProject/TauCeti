...
* `TauCeti.QuadraticMap.matrixSpecialOrthogonalToWeightedSumSquaresOne` turns a matrix special
  orthogonal transformation into an isometry of the standard sum-of-squares form.
...
theorem matrixSpecialOrthogonalToWeightedSumSquaresOne_apply
  ...
  by
    rw [matrixSpecialOrthogonalToWeightedSumSquaresOne]
    rfl
