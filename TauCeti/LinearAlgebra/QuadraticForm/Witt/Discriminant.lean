...
* `TauCetiRoadmap/QuadraticFormInvariants/Suggested.lean`, Layer 4's `signedDiscrHom`,
  `signedDiscrHom_surjective`, and `signedDiscrHom_eq_zero_iff`, whose target signatures this
  module follows.
-/
